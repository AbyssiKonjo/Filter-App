...
function filterProperties() {
    const filterProperties = properties.filter(property => {
        ...
        const propertyLocation = property.location.toLocaleLowerCase();
        const fillterValue = locationFilter.value.toLocaleLowerCase();
        // that it doesnt match so it doesent add to the array
        if (fillterValue && !propertyLocation.includes(fillterValue)) {
        ...
        // If all the conditions pass, include the proper in the filtered array
        return true;
    });
